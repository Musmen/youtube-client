...
## Branch "task-5" ([link to PR#5](https://github.com/Musmen/youtube-client/pull/5)): 
### Task "Angular. NgRX" ([link](https://github.com/rolling-scopes-school/tasks/blob/master/tasks/angular/NgRX.md))
